    ...
    <div class="card">
        <form action="{{ route('faculties.update',$faculty) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-header">
                <h5 class="mb-0">Edit global faculty</h5>
                @if ($errors->any())
            ...
            <div class="card-body row">
                <div class="mb-3 col-md-4">
                    ...
                    <input type="text" id="fullname" class="form-control" name="fullname" placeholder="Full name" value="{{ $faculty->fullname }}">
                </div>
                <div class="mb-3 col-md-4">
                    <label for="phone" class="form-label">Phone number<span class="text-danger fw-bold">*</span></label>
                    <input type="number" id="phone" class="form-control" name="phone" placeholder="Full name" value="{{ $faculty->phone }}">
                </div>

                <div class="mb-3 col-md-4">
                    <label for="job_time" class="form-label">Job time<span class="text-danger fw-bold">*</span></label>
                    <input type="text" id="job_time" class="form-control" name="job_time" placeholder="08:30 - 18:00" value="{{ $faculty->job_time }}">
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <textarea name="job_position" id="job_position" rows="10" cols="3" class="form-control"
                              placeholder="Job position">{{ $faculty->job_position }}</textarea>
                </div>

                <div class="mb-3 col-md-4">
                    <label for="description" class="form-label">Description</label>
                    <textarea name="description" id="description" rows="10" cols="3" class="form-control"
                              placeholder="Description">{{ $faculty->description }}</textarea>
                </div>
